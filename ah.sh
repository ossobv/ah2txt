...
group_output() {
    ...
    awk '
        ...
        $0~"[Aa]ppel|[Bb]ananen|Bleekselderij|[Bb]ramen|druiven |frambozen|Gember|Granny Smith|[Kk]aki fruit| [kK]iwi |Limoenen|[Mm]andarijnen|Peren|[Pp]erziken|sinaasappelen|Snoepgroente|Winterpeen|Wortelen"{genre="fruit"}
