...
group_output() {
    ...
    awk '
        ...
        $0~"Allioli|Augurk| augurken| augurken|Avocado|Bona|boter|confiture|[Hh]oemoes|[Hh]ummus| jam|Johma|Komkommer|Leverpastei|Lotus|[Mm]ayonaise| mosterd|pindakaas|Rucola|[Ss]la| spread|Sriracha|stroop|tomaten| uien|uien|Vlokfeest|zeezout"{genre="condiment"}
